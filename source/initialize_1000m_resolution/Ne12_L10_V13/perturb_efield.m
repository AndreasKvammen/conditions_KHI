...
params = struct(...
  ...
  'ell', 10.0e3, ...  % scale length for shear transition
  'B1val', -47500e-9, ...
...
% !!!! NOTE SCALE FACTOR !!!
%scalefact=1; % This causes ne_mean = 4.95e10
% scalefact=2; % This causes ne_mean = 9.91e10 
%scalefact=10;  % This causes ne_mean = 4.955e11 
scalefact=20;  % This causes ne_mean = 4.955e11 
% !!!! NOTE SCALE FACTOR !!!
for isp=1:lsp-1
